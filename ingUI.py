# Form implementation generated from reading ui file 'ingredUI.ui'
#
...
class ing_Dialog(object):
    def setupUi(self, Dialog):
        Dialog.setObjectName("Dialog")
        Dialog.resize(407, 300)
        self.list_ing = QtWidgets.QListWidget(Dialog)
        self.list_ing.setGeometry(QtCore.QRect(15, 71, 371, 161))
        self.list_ing.setStyleSheet("border-radius: 15px;\n"
"")

        self.list_ing.setObjectName("list_ing")
...
"background-color:rgb(226, 230, 234)")
    ...
    def retranslateUi(self, Dialog):
        ...
        Dialog.setWindowTitle(_translate("Dialog", "Ingredientes"))
    ...
    def add_food(self):
        try:
            ...
            row = self.list_ing.currentRow()
            cant = self.line_cant.text()
            id_menu = self.select_id_ord_act()
            id_inv = self.select_id_inv_act()
            ...
            if row >=0:
                ...
                if cant == "":
                    ...
                    mycursor = mydb.cursor()
                    query = "INSERT INTO hikaru.item_menu (id_menu,nombre, cantidad, id_inv) VALUES (%s,%s,%s)"
                    values = (id_menu, nom, cant, id_inv)
    ...
    def select_id_ord_act(self):
        try:
            ...
            query = "SELECT id_menu FROM menu ORDER BY id_menu DESC"
    ...
    def select_id_inv_act(self):
        try:
            ...
            query = "SELECT id_inv FROM inventario WHERE nombre like '"+ nom +"'"
